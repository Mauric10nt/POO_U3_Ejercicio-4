...
class ManejadorCalefactores:
    ...
    def cargarElectricoscsv(self, nombreArchivo:str) -> None:
        ...
        for fila in reader:
            ...
            try:
                ...
                print("No se pudo cargar el calefactor electrico de la fila {0}".format(contador))
            else:
                self.agregarCalefactor(unCalefactorElectrico)
    

    def cargarGascsv(self, nombreArchivo:str):
        archivo = open(nombreArchivo)
        reader = csv.reader(archivo, delimiter=";")
        next(reader)
        contador = 0
        for fila in reader:
            ...
            try:
                ...
                print("No se pudo cargar el calefactor a gas de la fila {0}".format(contador))
            else:
